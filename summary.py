...
def summarize_instructions(audacity_folder):
    ...
    for file_path in audacity_files:
        ...
        missed_audio = sorted(set(total_audio_instructions) - detected_audio, key=lambda x: int(x))
    ...
    with open(csv_file_path, 'w', newline='') as csvfile:
        fieldnames = ['Session', 'Total Audio Instructions Detected', 'Total Stories Detected', 'Missed Audio Instructions', 'Missed Stories']
...
if __name__ == "__main__":
    audacity_folder = '/Users/iktae.kim/semantic_sommeliers/data/nsr_8000_hc_3500_lc_500/audacity'
